...
const Modal = ({ openModal, modalData }) => {
          ...
          <section className="grid grid-cols-1 ">
            <section>
              ...
              <section className="py-3 px-6">
                ...
                <p className="text-dark dark:text-light capitalize">released : <span>{modalData.released}</span> </p>
                <p className="py-4 capitalize text-justify leading-[25px] text-dark dark:text-light text-[1.1rem]">{modalData.description_raw?.split(" ", 150).join(" ")}</p>
              </section>
